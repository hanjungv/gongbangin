        ...
        return this.each(function () {
            function e() {
                if (!E.data("alreadyinitialized")) {
                    ...
                    r(), u(), w(), d(), b(), v(), m(), g(), P.input.css("display", "block")
                }
            }
            ...
            function d() {
                var t = E.val(),
                    o = E.parent();
                "" !== t && (t = Number(t).toFixed(M.decimals)), E.data("initvalue", t).val(t), E.addClass("form-control"), o.hasClass("input-group") ? f(o) : h()
            }
            ...
            function w() {
                var t, o, n;
                t = E.val(), "" !== t && (M.decimals > 0 && "." === t || (o = parseFloat(t), isNaN(o) && (o = 0), n = o, o.toString() !== t && (n = o), o < M.min && (n = M.min), o > M.max && (n = M.max), n = x(n), Number(t).toString() !== n.toString() && (E.val(n), E.trigger("change"))))
            }
